  ...
  return (
    <div style={{ backgroundColor: '#1a1a3e', color: '#ffffff' }} className="min-h-screen">
      ...
      <header style={{ 
        ...
        <div style={{ maxWidth: '80rem', margin: '0 auto', padding: '1.5rem 1rem' }} className="sm:px-6 lg:px-8">
          <h1 style={{ 
      ...
      {/* Main Content */}
      <main style={{ maxWidth: '80rem', margin: '0 auto', padding: '3rem 1rem' }} className="sm:px-6 lg:px-8">
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '2rem' }}>
          ...
          <section style={{ 
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', marginBottom: '1.5rem' }}>
              ...
              <h2 style={{ fontSize: '1.5rem', fontWeight: 'bold', color: '#1a1a3e' }}>
                API Key
              </h2>
            </div>
            ...
            <div style={{ marginBottom: '1.5rem' }}>
              ...
              <div style={{ display: 'flex', gap: '0.5rem', alignItems: 'center' }}>
                ...
                >
                  {showApiKey ? <EyeOff style={{ width: '1rem', height: '1rem' }} /> : <Eye style={{ width: '1rem', height: '1rem' }} />}
                </button>
                <button
            ...
            >
              <div>
                {testMode ? (
                  <ToggleRight style={{ width: '1.5rem', height: '1.5rem', color: '#fbbf24' }} />
                ) : (
                  <ToggleLeft style={{ width: '1.5rem', height: '1.5rem', color: '#9ca3af' }} />
                )}
              </div>
              <div>
                ...
                <div style={{ fontSize: '0.75rem', color: '#6b7280' }}>
                  {testMode ? 'Enabled - Requests are sandboxed' : 'Disabled - Using live endpoint'}
                </div>
              </div>
            </div>
          </section>
          ...
          <section style={{ 
            ...
            <h2 style={{ fontSize: '1.5rem', fontWeight: 'bold', color: '#1a1a3e', marginBottom: '1.5rem' }}>
              API Status
            </h2>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
              <div style={{
                ...
                <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '0.5rem' }}>
                  <span style={{ fontSize: '0.875rem', color: '#1a1a3e' }}>Status</span>
                  <span style={{
                ...
                <p style={{ fontSize: '0.75rem', color: '#6b7280' }}>All systems operational</p>
              </div>
              ...
              <div style={{
                ...
                <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '0.5rem' }}>
                  <span style={{ fontSize: '0.875rem', color: '#1a1a3e' }}>Uptime</span>
                  <span style={{ fontSize: '0.875rem', fontWeight: '600', color: '#fbbf24' }}>99.99%</span>
                </div>
                <p style={{ fontSize: '0.75rem', color: '#6b7280' }}>Last 30 days</p>
              </div>
              ...
              <div style={{
                ...
                <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '0.5rem' }}>
                  <span style={{ fontSize: '0.875rem', color: '#1a1a3e' }}>Response Time</span>
                  <span style={{ fontSize: '0.875rem', fontWeight: '600', color: '#fbbf24' }}>145ms</span>
                </div>
                <p style={{ fontSize: '0.75rem', color: '#6b7280' }}>Average latency</p>
              </div>
              ...
              <div style={{
                ...
                <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '0.5rem' }}>
                  <span style={{ fontSize: '0.875rem', color: '#1a1a3e' }}>Rate Limit</span>
                  <span style={{ fontSize: '0.875rem', fontWeight: '600', color: '#fbbf24' }}>10,000/min</span>
                </div>
                <p style={{ fontSize: '0.75rem', color: '#6b7280' }}>Per API key</p>
              </div>
            </div>
          </section>
        </div>
            ...
            {[
              ...
              <button
                ...
                style={{
                  ...
                  borderBottomColor: activeTab === tab.id ? '#fbbf24' : 'transparent',
            ...
            <div>
              ...
              <button
                onClick={() => copyToClipboard(
                  activeTab === 'rest' ? restRequest : activeTab === 'js' ? jsRequest : pythonRequest,
                  `request-${activeTab}`
                )}
                style={{
                  marginTop: '0.75rem',
